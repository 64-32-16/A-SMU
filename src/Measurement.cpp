...
/*----------------------------------------------------------------------------------
    CurrentMeasurementClass
------------------------------------------------------------------------------------*/

CurrentMeasurementClass::CurrentMeasurementClass(MeasurementType type, int32_t maxADC, int32_t minADC) : MeasurementClass(type, maxADC, minADC)
{
...
/*----------------------------------------------------------------------------------
    VoltageMeasurementClass
------------------------------------------------------------------------------------*/

VoltageMeasurementClass::VoltageMeasurementClass(MeasurementType type, int32_t maxADC, int32_t minADC) : MeasurementClass(type, maxADC, minADC)
{
...
void ResistorMeasurementClass::OnSelect()
{
}
