...
#define THEME_CURRENT_LABEL_COLOR 0xf000 	// gree
#define THEME_VOLTAGE_LABEL_COLOR 0x5cacf7	// blue
#define THEME_POWER_LABEL_COLOR 0xff7f27	// orange
#define THEME_RESISTOR_LABEL_COLOR 0xf2ea0a	// yellow
