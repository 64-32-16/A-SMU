#ifndef _CURRENT_SOURCE_PANEL_H_INCLUDED
#define _CURRENT_SOURCE_PANEL_H_INCLUDED
...
class CurrentSourcePanel : public Panel
{
public:
    CurrentSourcePanel();
    CurrentSourcePanel(int16_t x, int16_t y, int16_t w, int16_t h);
